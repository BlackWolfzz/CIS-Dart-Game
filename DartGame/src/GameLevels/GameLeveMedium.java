 ...
 *
 */
public class GameLeveMedium extends JFrame implements ActionListener {
 ...
 */
	 ...
	 * @param player
	 */
	public GameLeveMedium(String player) {
		super();
		initGame(player);
	}
	...
	public static void main(String[] args) {
		GameLeveMedium myGUI = new GameLeveMedium();
